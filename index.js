...
//if the trip is over 10 blocks distance and true if the distance
//is within range. So produceDrivingRange returns a
//function that we can then use to calculate if a trip
//is too large for a driver. We recommend referencing
//the test/indexTest.js for more details.

//it('takes an argument of blockRange which is then used to calculate
...
//ten percent tip on a fare. produceTipCalculator(.20)
...
//reference to a driverId that is incremented each
//time a new driver is created. The rest of the code base
